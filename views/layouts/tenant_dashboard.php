                            ...
                            <li style="margin-top: 5px;">
                                ...
                                <div class="dropdown user-dropdown">
                                    ...
                                    <ul id="w0" class="dropdown-menu userdropdown nav">
                                        ...
                                        <li><a href="<?php echo Url::home(true); ?>site/myagreements">My Agreements</a></li>
                                        <li><a href="<?php echo Url::home(true); ?>site/mypaymentsdue">Payments</a></li>
                                        <li><a href="<?php echo Url::home(true); ?>site/myrequests">Service Request</a></li>
                                        <li><a data-toggle="modal" data-target="#myModalc" id="fchangepassword" data-backdrop="static" data-keyboard="false" >Change Password</a></li>
                                        <li>
        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
                    <li>
                        <a href="<?php echo Url::home(true); ?>/site/dashboard" <?php if ($action == 'dashboard') { ?>class="active"<?php } ?>>
                    ...
                    <li class="open" id="myprofile_dropdown" >
                        ...
                        <ul class="collapse list-unstyled" id="homeSubmenu" aria-expanded="true">
                            ...
                            <li>
                                <a href="<?php echo Url::home(true); ?>site/myprofile?type=sp" <?php if ($type == 'sp') { ?>class="active"<?php } ?>>Support Person Details</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="<?php echo Url::home(true); ?>site/myagreements" <?php if ($action == 'myagreements') { ?>class="active"<?php } ?>>
                            <img src="<?php echo Url::home(true); ?>images/icons/ic-my-agreement.svg" width="8%"> My Agreements</a>
                    </li>
                    <!--li>
                        <a href="<?php echo Url::home(true); ?>site/mypaymentsdue" <?php if ($action == 'mypaymentsdue') { ?>class="active"<?php } ?>>
                            <img src="<?php echo Url::home(true); ?>images/img/ic-wallet.png" width="8%"> Payments</a>
                    </li-->

                    <li class="">
                        <a href="<?php echo Url::home(true); ?>site/mypaymentsdue" aria-expanded="false" class="collapsed">
                            <img src="<?php echo Url::home(true); ?>images/img/ic-wallet.png" width="8%"> Payments</a> 

<?php if ($action == "mypaymentsdue" || $action == "mypaymentsforcast" || $action == "mypayments") { ?>
                            <ul class="collapse in list-unstyled" id="homeSubmenut" aria-expanded="true">

                                <li>
                                    <a href="<?php echo Url::home(true); ?>site/mypaymentsdue" onclick="mainpage();" <?php if (($action == 'mypaymentsdue')) { ?>class="active"<?php } ?>>Payment Due</a>
                                </li>
                                <li>
                                    <a href="<?php echo Url::home(true); ?>site/mypaymentsforcast" onclick="getaddressproof();" <?php if ($action == 'mypaymentsforcast') { ?>class="active"<?php } ?>>Payment Forecast</a>
                                </li>
                                <li>
                                    <a href="<?php echo Url::home(true); ?>site/mypayments" onclick="getbankdetail();" <?php if ($action == 'mypayments') { ?>class="active"<?php } ?>>Payment History</a>
                                </li>
...
<?php } ?>	
                    ...
                    <li>
                        <a href="<?php echo Url::home(true); ?>site/myrequests" <?php if ($action == 'myrequests') { ?>class="active"<?php } ?>>
