    ...
    <?php if (!empty(Yii::$app->session->getFlash('noti-success'))) { ?>
        ...
        <?php ActiveForm::end(); ?>
                            ...
                            <div style="margin: auto;" class="col-xs-6 col-sm-6 col-md-6 col-xl-6">
                                <button type="submit" id="pop-up-notification-close" style="width: 100%; font-weight: bold; font-size: 16px;" class="btn btn-md btn-primary btn_mycolor">
                                    Close
                                </button>
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right custom_nav_right <?php echo $nameclass; ?>">
                            ...
                            ?>
                            <li>
                                <!--<span id="remaining_day_pass" style=" margin-top: 1%;"></span>-->		
                            ...
                            <li style="margin-top: 5px;">
                                ...
                                <div class="dropdown user-dropdown">
                                    ...
                                    <ul id="w0" class="dropdown-menu userdropdown nav">
                                        <li class="active"><a href="<?php echo Url::home(true); ?>advisers/myprofile?type=p">My Profile</a></li>
                                        <li><a href="<?php echo Url::home(true); ?>advisers/owner">Refer property owner</a></li>
                                        <li><a href="<?php echo Url::home(true); ?>advisers/applicant">Refer Tenant</a></li>
                                        <li><a href="<?php echo Url::home(true); ?>advisers/myreferred">Client Onboarding Status</a></li>
                                        <li><a href="<?php echo Url::home(true); ?>advisers/ownerreferred">Property Owner Details</a></li>
                                        <li><a href="<?php echo Url::home(true); ?>advisers/tenantreferred">Tenant Details</a></li>
                                        <li><a href="<?php echo Url::home(true); ?>advisers/feesdetails">Fees Details</a></li>
                ...
                <ul class="list-unstyled components">
                    <li class="open" id="myprofile_dropdown" >
                        ...
                        <ul class="collapse list-unstyled" id="homeSubmenu" aria-expanded="true">
                            <li>
                                <a href="<?php echo Url::home(true); ?>advisers/myprofile?type=p" onclick="mainpage();" <?php if (($type == 'p') || ($action == 'myprofile' && $type == '')) { ?>class="active"<?php } ?>>Personal Information</a>
                            </li>
                            <li>
                                <a href="<?php echo Url::home(true); ?>advisers/myprofile?type=i" onclick="getaddressproof();" <?php if ($type == 'i') { ?>class="active"<?php } ?>>Identity and address proof</a>
                            </li>
                            <li>
                                <a href="<?php echo Url::home(true); ?>advisers/myprofile?type=a" onclick="getbankdetail();" <?php if ($type == 'a') { ?>class="active"<?php } ?>>Agreement Contract Details</a>
                            </li>
                            <li>
                                <a href="<?php echo Url::home(true); ?>advisers/myprofile?type=b" onclick="getbankdetail();" <?php if ($type == 'b') { ?>class="active"<?php } ?>>My Bank details</a>
                            </li>

                            <li>
                                <a href="<?php echo Url::home(true); ?>advisers/myprofile?type=s" onclick="emergencycontact();" <?php if ($type == 's') { ?>class="active"<?php } ?>>Support Person Details</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="<?php echo Url::home(true); ?>advisers/owner" <?php if ($action == 'owner') { ?>class="active"<?php } ?>>
                            <img src="<?php echo Url::home(true); ?>images/img/ic-refer-property-owner.svg" width="8%"> Refer property owner</a>
                    </li>
                    <li>
                        <a href="<?php echo Url::home(true); ?>advisers/applicant" onclick="getwallet();" <?php if ($action == 'applicant') { ?>class="active"<?php } ?>>
                            <img src="<?php echo Url::home(true); ?>images/img/ic-refer-tenant.svg" width="8%"> Refer Tenant</a>
                    </li>
                    <li>
                        <a href="<?php echo Url::home(true); ?>advisers/myreferred" onclick="searchproperty();" <?php if ($action == 'myreferred') { ?>class="active"<?php } ?>>
                            <img src="<?php echo Url::home(true); ?>images/img/ic-client-onboarding-status.svg" width="8%"> Client Onboarding Status</a>
                    </li>
                    <li>
                        <a href="<?php echo Url::home(true); ?>advisers/ownerreferred" onclick="searchproperty();" <?php if ($action == 'ownerreferred') { ?>class="active"<?php } ?>>
                            <img src="<?php echo Url::home(true); ?>images/img/ic-property-owner-details.svg" width="8%"> Property Owner Details</a>
                    </li>
                    <li>
                        <a href="<?php echo Url::home(true); ?>advisers/tenantreferred" onclick="searchproperty();" <?php if ($action == 'tenantreferred') { ?>class="active"<?php } ?>>
                            <img src="<?php echo Url::home(true); ?>images/img/ic-tenant-details.svg" width="8%"> My Referred Tenants</a>
                    </li>
                    <li>
                        <a href="<?php echo Url::home(true); ?>advisers/feesdetails" onclick="searchproperty();" <?php if ($action == 'feesdetails') { ?>class="active"<?php } ?>>
                            <img src="<?php echo Url::home(true); ?>images/img/ic-fees-details.svg" width="8%"> Fee Details</a>
                    </li>
                </ul>
            </nav>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="modal_body">
                        <form method="post" id="passwordForm" name="passwordForm" action="<?php echo Url::home(true); ?>users/changepassword">
                            ...
                            <a id="forgot" style="color: blue; float: right; margin-top: 10px;" href="http://localhost/pms/web/site/forget">Forgot Password?</a>
                        </form>
                    </div>
                </div>
...
<?php $this->endBody() ?>
        ...
        <script type="text/javascript">
            ...
            $(function () {
                if ((window.location.href == "<?php echo Url::home(true); ?>advisers/myprofile?type=p") || (window.location.href == "<?php echo Url::home(true); ?>advisers/myprofile?type=b") || (window.location.href == "<?php echo Url::home(true); ?>advisers/myprofile?type=i") || (window.location.href == "<?php echo Url::home(true); ?>advisers/myprofile?type=a") || (window.location.href == "<?php echo Url::home(true); ?>advisers/myprofile?type=s") || (window.location.href == "<?php echo Url::home(true); ?>advisers/myprofile")) {
