...
<html lang="<?= Yii::$app->language ?>">
    <head>
        ...
        <meta name="keywords" content="Property advisors brokers partner technology platform">
        ...
        <?php } else { ?>
            <title>Property Management Services | Real Estate Advisors</title>
            <meta name="description" content="Rental & Property Management | Calling real-estate advisors to partner | Generate annuity income | Get access to our technology platform | Contact us">
        <?php } ?>
        <?php $this->head() ?>
