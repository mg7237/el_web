...
<body>
 ...
 <!--<span id="remaining_day_pass" >ssssssssssssss</span>-->                           
    ...
    <div class="modal fade cust-mdlfd" id="myModalc" role="dialog" data-keyboard="false" data-backdrop="static" >
        <div class="modal-dialog cust-modal" style="width: 494px;height: 392px;">
            <!-- Modal content-->
            <div class="modal-content" style="background-color: #fafafa;">
                ...
                <div class="modal-body" id="modal_body">
                    <form method="post" id="passwordForm" name="passwordForm" action="<?php echo Url::home(true); ?>users/changepassword">
                        ...
                        <div class="form-group">
                            <input type="submit" class="col-xs-12 btn btn-danger cust-smbt btn-load btn-lg" data-loading-text="Changing Password..." value="Change Password" onclick="changepassword();" style="width: 414px;height: 48px;border-radius: 3px;margin-left: 25px;">
                        </div>
