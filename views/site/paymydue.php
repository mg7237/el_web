                        ...
                        <div class="tab-content">
                            <div id="login-with-email" class="tab-pane active">
                                ...
                                <?php if (!empty(Yii::$app->getSession()->getFlash('error'))) { ?>
                                    <center>
                                        <div id="sucess_msg" style="color: red; font-weight: bold;">
                                            <?php echo Yii::$app->getSession()->getFlash('error'); ?>
                                        </div>
                                    </center>
                                <?php } ?>
                                <input type="text" id="loginform-username" class="sign-up-input" name="email_mobile" placeholder="E-mail or mobile *" aria-required="true" aria-invalid="false">
                                <br /><br />
                                <?= Html::submitButton('Pay My Due', ['class' => 'btn savechanges_submit_login sign-up-button no-margin', 'name' => 'login-button']) ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="checkbox">
                                        <span id="login_span"> <p>Want to login? <a href="<?php echo Url::home(true); ?>site/login">Sign In</a></p></span>
                                    </label>
                                </div>
                            </div>
                        </div>
