...
<div id="content">
    ...
    <hr>
    <form method="post" enctype="multipart/form-data" action="<?= \Yii::$app->getUrlManager()->createUrl('site/editbankdetail') ?>" name="bank_info" id="bank_info"> 
        <div class="container">
            ...
            <div class="col-md-10 col-sm-10 bgstyle disable_sec" id="disable_sec_div">
                ...
                <div class="form-group col-md-4 col-sm-4">
                    ...
                    <div class="input-group cust-inptgroup colorpicker colorpicker-element">
                        <div class="form-line">
                ...
                <div class="form-group col-md-4 col-sm-4">
                    ...
                    <div class="input-group cust-inptgroup colorpicker colorpicker-element">
                        <div class="form-line focused">
                            <input type="text" class="form-control" value="<?= $model->bank_account_number; ?>" id="bank_account_number" name="bank_account_number" readonly>
                        </div>
                    </div>
                </div>
                <div class="form-group col-md-4 col-sm-4">
                ...
                <div class="col-md-form-group col-md-4 col-sm-4">
                ...
                <div class="col-md-form-group col-md-9 col-sm-9" style="height: 250px;">
...
<style>
    ...
    @media screen and (min-width: 770px) and (max-width: 1198px){
        .cust-save{
