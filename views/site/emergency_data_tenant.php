...
<div id="content">
    ...
    <hr>
    <form method="post" enctype="multipart/form-data" action="<?= \Yii::$app->getUrlManager()->createUrl('site/editemergencydetailtenant') ?>" name="em_info" id="em_info"> 
        <div class="container">

            <div class="container-fluid" style="margin-left: -15px;">
                <h4 class="col-md-4" style="margin-bottom: 22px !important;" id="personal_info">MY EMERGENCY CONTACT DETAILS</h4>				
            </div>
            <div class="col-md-12 bgstyle disable_sec" id="disable_sec_div1">
                <div class="row">
                    <div class="col-md-4">
                        <b id="bold">Name *</b>
                        <div class="input-group colorpicker colorpicker-element">
                            <div class="form-line">
                                <input type="text" class="form-control" value="<?= $model->emergency_contact_name; ?>" name="em_name" id="em_name" >
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group colorpicker colorpicker-element">
                            <div class="form-line focused">
                                <input type="text" class="form-control" value="<?php echo $model->emer_contact_address; ?>" name="em_email" id="em_email"  onblur="checkEmail(this.value);">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="input-group colorpicker colorpicker-element">
                            <div class="form-line focused">
                                <input type="text" class="form-control" value="<?= $model->emergency_contact_number; ?>" name="em_mobile" id="em_mobile"  maxlength="15">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="uploadbox">	
                        <div class="col-md-6 col-sm-6">
                            ...
                            <select class="selectpicker IDproof cus_hide"  id="id_proof">
                        ...
                        <div class="row identity_image_preview">
                            ...
                            foreach ($emergency_proofs as $value) {
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <img class= "preview" alt=""  src="../<?php echo $value->proof_document_url ?>"><p style="margin-left: 15px;"><?php echo Yii::$app->userdata->getProofType($value->proof_type); ?></p><a class="removeEmergency" data-id="<?= $value->id ?>"></a>
                                </div>
                                <?php
                            }
                            ?>
...
<style>
    ...
    @media screen and (max-width: 1198px) and (min-width: 770px) {
        .cust-edit {
