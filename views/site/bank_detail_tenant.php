...
<div id="content">
    ...
    <hr>
    <form method="post" enctype="multipart/form-data" action="<?= \Yii::$app->getUrlManager()->createUrl('site/editbankdetailtenant') ?>" name="bank_info" id="bank_info"> 
        <div class="container">
            ...
            <div class="col-md-12 bgstyle disable_sec" id="disable_sec_div">
                ...
                <div class="col-md-form-group col-md-4">
                ...
                <div class="col-md-form-group col-md-9" style="height: 250px;">
                    ...
                    <b id="bold">Cancelled Cheque <span id="cancelmark cust-cancelcheck" class="cus_hide tooltip_s" data-toggle="tooltip" title="Name on the cancelled cheque should match your name" style="width: 530px;float: right;">?</span></b>
                    <div class="well" id="bank_well" style="padding-right: 5px;padding-left: 7px;padding-top: 5px;margin-bottom: 5px;margin-top: 5px;padding-bottom: 5px;">
                        ...
                        <div class="box">
                            ...
                            <?= !empty($model->cancelled_check) ? '<a class="removeCancelledCheck" attr-id="' . $model->tenant_id . '"></a>' : '' ?>
