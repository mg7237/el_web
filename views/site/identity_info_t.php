...
<div id="content">
    ...
    <hr>
    <form method="post" enctype="multipart/form-data" action="<?= \Yii::$app->getUrlManager()->createUrl('site/editidentityinfo') ?>" name="identity_info" id="identity_info">
        <div class="container">
                                ...
                                if ($identity) {
                                    foreach ($identity as $key => $value) {
                                        ...
                                        <div class="col-md-3 col-sm-3">
                                            <img class= "preview" alt="" src="../<?= $value->proof_document_url; ?>"><p class="identityp"><?= Yii::$app->userdata->getProofType($value->proof_type); ?></p>
                                        </div>
                                        <?php
                                    }
                                }
