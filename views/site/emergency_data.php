...
<div id="content">
    ...
    <hr>
    <form method="post" enctype="multipart/form-data" action="<?= \Yii::$app->getUrlManager()->createUrl('site/editemergencydetail') ?>" name="em_info" id="em_info"> 
        <div class="container">

            <div class="container-fluid" style="margin-left: -15px;">
                <h4 class="col-md-4" style="margin-bottom: 22px !important;" id="personal_info">MY EMERGENCY CONTACT DETAILS</h4>				
            </div>
            <div class="col-md-10 bgstyle disable_sec" id="disable_sec_div1">
                <div class="col-md-4">
                    <b id="bold">Name *</b>
                    <div class="input-group cust-inputgrp colorpicker colorpicker-element">
                        <div class="form-line">
                            <input type="text" class="form-control" value="<?= $model->emergency_contact_name; ?>" name="em_name" id="em_name" readonly>
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group cust-inputgrp colorpicker colorpicker-element">
                        <div class="form-line focused">
                            <input type="text" class="form-control" value="<?= $model->emergency_contact_number; ?>" name="em_mobile" id="em_mobile" readonly maxlength="15">
                        </div>
                    </div>
                </div>

                <div class="col-md-10" style="padding: 15px;margin-left: -30px;">
