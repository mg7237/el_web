...
<?php if ($model->propertyListing->token_amount != 0) { ?>
    <?php if (!$booked) { ?>
                                        ...
                                        <p class="text-center">
                                            Book this one by paying &#8377;<?= $model->propertyListing->token_amount ?>
                                        </p>
                                        <?php if (empty($visitdate)) { ?>
                                            <p class="sub-text book-desc" style="display: block;">
    ...
    <section id="property-macros">
        <div class="row">
            <div class="col-lg-8 mt-3 bg-white p-4">
                ...
                <div class="row">
                    <div class="col-lg-3"><h4 class="sub-text">Rent</h4><p><span class="header-line">&#8377;<?php echo Yii::$app->userdata->getFormattedMoney($model->propertyListing->rent); ?></span></p></div>
                    <div class="col-lg-3 px-0"><h4 class="sub-text">Maintenance</h4><p><span class="header-line"><?php echo ($model->propertyListing->maintenance == '0' || $model->propertyListing->maintenance == '') ? 'Included' : '&#8377;' . Yii::$app->userdata->getFormattedMoney($model->propertyListing->maintenance); ?></span></p></div>
                    <div class="col-lg-3"><h4 class="sub-text">Deposit</h4><p><span class="header-line">&#8377;<?php echo Yii::$app->userdata->getFormattedMoney($model->propertyListing->deposit); ?></span></p></div>
        ...
        <section id="property-details">
            <div class="row">
                <div class="col-lg-8 mt-3 bg-white p-4">
                    <div class="row pb-3">
                        <div class="col-lg-1">
                            <div class="radio">
                                <label><input class="custom-radio-size" type="radio" name="optradio"></label>
                            </div>
                        </div>
                        <div class="col-lg-11">
                    ...
                    <div class="row">
                        <div class="col-lg-5 pr-0"><h6 class="property-pricing-title">Room</h6><span class="property-pricing-val">1 sharing with attached bathroom<br />Available from 01-Jan-2019</span></div>
                        <div class="col-lg-2 pr-0"><h6 class="property-pricing-title">Rent</h6><span class="property-pricing-val">&#8377;5,000</span></div>
                        <div class="col-lg-3 pr-0"><h6 class="property-pricing-title">Maintenance</h6><span class="property-pricing-val">Included</span></div>
                        <div class="col-lg-2 pr-0"><h6 class="property-pricing-title">Deposit</h6><span class="property-pricing-val">&#8377;15,000</span></div>
                    </div>
                </div>
                <div class="col-lg-4"></div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 mt-3 bg-white p-4">
                    ...
                    <div class="row">
                        <div class="col-lg-5 pr-0"><h6 class="property-pricing-title">Room</h6><span class="property-pricing-val">2 sharing with attached bathroom<br />Available from 01-Jan-2019</span></div>
                        <div class="col-lg-2 pr-0"><h6 class="property-pricing-title">Rent</h6><span class="property-pricing-val">&#8377;5,000</span></div>
                        <div class="col-lg-3 pr-0"><h6 class="property-pricing-title">Maintenance</h6><span class="property-pricing-val">Included</span></div>
                        <div class="col-lg-2 pr-0"><h6 class="property-pricing-title">Deposit</h6><span class="property-pricing-val">&#8377;15,000</span></div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-8 mt-3 bg-white p-4">
                    ...
                    <div class="row">
                        <div class="col-lg-5 pr-0"><h6 class="property-pricing-title">Room</h6><span class="property-pricing-val">3 sharing with attached bathroom<br />Available from 01-Jan-2019</span></div>
                        <div class="col-lg-2 pr-0"><h6 class="property-pricing-title">Rent</h6><span class="property-pricing-val">&#8377;5,000</span></div>
                        <div class="col-lg-3 pr-0"><h6 class="property-pricing-title">Maintenance</h6><span class="property-pricing-val">Included</span></div>
                        <div class="col-lg-2 pr-0"><h6 class="property-pricing-title">Deposit</h6><span class="property-pricing-val">&#8377;15,000</span></div>
                    </div>
