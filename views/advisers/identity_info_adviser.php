...
<div id="content">
    ...
    <div class="container" style="margin-top: -42px;">
        ...
        <div class="col-md-6" style="margin-left: 20px;">
            ...
            <button id="first_button" class="btn btn btn-info btn-lg pull-right cancelbutton cus_hide cust-save" style="margin-right:20px !important;background-color: #aea1a0 !important;border-color: #aea1a0 !important;" onclick="cancelform()">Cancel</button>
        </div>
    </div>
    <hr>
    <form method="post" enctype="multipart/form-data" action="<?= \Yii::$app->getUrlManager()->createUrl('advisers/editidentityinfoadviser') ?>" name="identity_info" id="identity_info">
        <div class="container">
            ...
            <div class="col-md-12 bgstyle disable_sec" id="disable_sec_div">
                ...
                <div class="col-md-12 bgstyle" style="padding-left: 0px !important;">
                    <div class="row">
                        <div class="uploadbox" id="editbox">
                            ...
                            <div class="row identity_image_preview">
                                ...
                                foreach ($address_proofs as $key => $value) {
                                    ?>
                                    <div class="col-md-3 col-sm-3 cust-prepad">
