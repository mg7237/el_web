                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-xs-offset-1">
                        ...
                        <div class="parmentaddress">
                            ...
                            <div class="parmentaddress resetbox">
                                <?= $form->field($model, 'emer_contact')->textInput(['maxlength' => true, 'placeholder' => 'Emergency contact name*', 'class' => 'form-control isCharacter'])->label('Emergency Contact Name') ?>
                            ...
                            <div class="parmentaddress resetbox">
                                <?= $form->field($model, 'emergency_contact_number')->textInput(['maxlength' => true, 'placeholder' => 'Emergency contact number*', 'class' => 'form-control isPhone']) ?>
                            </div>
                            &nbsp;
                        ...
                        <div class="changepassword">
                            ...
                            <?= $form->field($model, 'bank_ifcs')->textInput(['maxlength' => true, 'placeholder' => 'IFSC*']) ?>      	
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="advisorbox">
                                            ...
                                            <div class="textrightbox">
                                                ...
                                                <p class="text-right" style="padding-right:9px; margin-bottom:0px;">
                                                    ...
                                                    if (!Yii::$app->userdata->getPropertyBookedStatus($property->id)) {
                                                        ?>
                                                        <a href="<?= Url::home(true) ?>sales/editproperty?id=<?= $property->id; ?>" onclick="$('body').on('hidden.bs.modal', '.modal', function () {
                            ...
                            <div class="clearfix"></div>						
                            <!----------add property---------------------->
                            <a href="<?= Url::home(true) ?>sales/addproperty?id=<?= base64_encode($model->owner_id); ?>" >Add Property</a>
                            <p></p>
