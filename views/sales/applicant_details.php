        ...
        <div class="tab-content">
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-xs-offset-2">
                                ...
                                <div class="parmentaddress">
                                    ...
                                    <?= $form->field($model, 'employment_start_date')->textInput(['maxlength' => true, 'placeholder' => 'DD-MMM-YYYY*']) ?>
                                ...
                                <div class="parmentaddress">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly value="<?= Yii::$app->userdata->getPhoneById($model->operation_id, 7); ?>"  id="operationphone"  placeholder="Support Person Name" class="form-control">
                                    </div>
            ...
            <div id="menu1" class="tab-pane fade">
                ...
                <div class="advisorbox">
                    ...
                    <?= $formLeads->field($modelLeads, 'follow_up_date_time')->textInput(['maxlength' => true, 'placeholder' => 'DD-MMM-YYYY*']) ?>
                            ...
                            <div class="propertyboxlarge ">
                                ...
                                <div class="propertynameright">
                                    ...
                                    <p class="text-right" style="padding-right:9px; margin-bottom:0px;">
                                        <a href="<?= Url::home(true) ?>sales/createlease?property_id=<?= $favData->child_properties; ?>&parent_id=<?= $favData->property_id; ?>&applicant_id=<?= $model->applicant_id; ?>" onclick="$('body').on('hidden.bs.modal', '.modal', function () {
