        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 pull-right">
                    <a href="<?php echo Url::home(true); ?>sales/createadviser" class="btn savechanges_submit_contractaction" data-toggle="modal" data-target="#myModal" style= "margin-top:15px;">Create Advisers</a>
                ...
                <div class="col-lg-12 advisortetxt">
                    ...
                    echo GridView::widget([
                        ...
                        'rowOptions' => function ($model, $key, $index, $grid) {
                            $class = 'clickable-row';
                            return array('key' => $key, 'data-href' => Url::home(true) . 'sales/advisersdetails?id=' . base64_encode($key), 'class' => $class);
                        },
                        'summary' => '',
