...
<div class="modal-header">
    ...
    <h4 class="modal-title modaltitletextnew">Create Property Owner Lead</h4>
...
<div class="modal-dialog modal-dialognew">
    ...
    <div class="modal-body loginbody signupbody">		
        ...
        <?= $form->field($model, 'full_name')->textInput(['maxlength' => true, 'placeholder' => 'Property owner name*', 'class' => 'form-control isCharacter'])->label(false); ?>

        <?= $form->field($model, 'email_id')->textInput(['maxlength' => true, 'placeholder' => 'Property owner email id*'])->label(false); ?>

        <?= $form->field($model, 'contact_number')->textInput(['maxlength' => true, 'placeholder' => 'Property owner contact number*', 'class' => 'form-control isPhone'])->label(false); ?>
