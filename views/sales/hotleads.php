            ...
            <table cellpadding="5" class="table table-bordered tableheadingrow">
                <thead>
                    <tr>
                        ...
                        <th width="12%">Reference ID<span aria-hidden="true" class="glyphicon glyphicon-triangle-bottom"></span></th>
                        <th width="12%">Type<span aria-hidden="true" class="glyphicon glyphicon-triangle-bottom"></span></th>
                        <th width="10%">Name<span aria-hidden="true" class="glyphicon glyphicon-triangle-bottom"></span></th>
                        <th width="19%">Contact details<span aria-hidden="true" class="glyphicon glyphicon-triangle-bottom"></span></th>
                        <th width="20%">Location/Address<span aria-hidden="true" class="glyphicon glyphicon-triangle-bottom"></span></th>
                        <th width="5%">Status<span aria-hidden="true" class="glyphicon glyphicon-triangle-bottom"></span></th>
                        <!-- <th width="17%">Type of Visit<span aria-hidden="true" class="glyphicon glyphicon-triangle-bottom"></span></th> -->
                        <th width="20%">Follow Up Date &amp; time<span aria-hidden="true" class="glyphicon glyphicon-triangle-bottom"></span></th>
                    ...
                    if (count($data) != 0) {
                        foreach ($data as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td><?= $value['follow_up_date_time']; ?></td>
                            </tr>
                            <?php
                        }
                    } else {
