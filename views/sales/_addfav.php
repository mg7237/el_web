...
<div class="modal-body modaltextpargh" style="float:left; width:100%; background:#FFFFFF;">
    ...
    <div class="parmentaddress resetbox">
        <?= $form->field($model, 'visit_date')->textInput(['maxlength' => true, 'class' => 'form-control datepicker', 'placeholder' => 'DD-MM-YYYY*']) ?>

    </div>
    <div class="parmentaddress resetbox">
        <?= $form->field($model, 'visit_time')->textInput(['maxlength' => true, 'class' => 'form-control', 'placeholder' => '10:35:40']) ?>
