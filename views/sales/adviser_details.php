        ...
        <div class="tab-content">
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-xs-offset-2">
                                ...
                                <div class="parmentaddress">
                                    ...
                                    <?= $form->field($model, 'phone')->textInput(['maxlength' => true, 'placeholder' => 'Phone Number*', 'class' => 'isPhone form-control']) ?>
                                ...
                                <div class="changepassword">
                                    ...
                                    <?= $form->field($model, 'bank_ifcs')->textInput(['maxlength' => true, 'placeholder' => 'Bank IFSC Code*'])->label('Bank IFSC Code') ?>      	
            ...
            <div id="menu1" class="tab-pane fade">
                ...
                <div class="advisorbox">
                    ...
                    <?= $formLeads->field($modelLeads, 'schedule_date_time')->textInput(['maxlength' => true, 'placeholder' => 'DD-MMM-YYYY *', 'class' => 'form-control datepicker'])->label('Schedule Start Date') ?>
