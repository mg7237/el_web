...
<script>
    ...
    $(document).ready(function () {
        ...
        if ($('#properties-property_type').val() <= 2) {
            $('#propertyagreements-agreement_type option').attr('disabled', true);
            ...
            $('#propertyagreements-agreement_type option[value="3"]').attr('disabled', true);
        }
    })
