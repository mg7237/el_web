...
<div id="page-wrapper">
    <div class="row">
        ...
        <div class="col-lg-8" style="margin: 0 auto;">
            ...
            <div class="parmentaddressnew">
                <div class="form-inline">
                    <?= $form->field($model, 'charges')->textInput(['maxlength' => true, 'placeholder' => 'Actual Charges*', 'class' => 'form-control isNumber'])->label('Actual Charges'); ?>
                    <?= $form->field($model, 'charges_to_owner')->textInput(['maxlength' => true, 'placeholder' => 'Charges To Owner*', 'class' => 'form-control isNumber'])->label('Charges To Owner'); ?>
                    <?= $form->field($model, 'payment_due_date')->textInput(['maxlength' => true, 'placeholder' => 'Due Date*', 'class' => 'form-control datepicker'])->label('Due Date'); ?>
...
//$states = \app\models\PropertyTypes::find()->all();
                    ...
                    ?>
                    <?= $form->field($model, 'status')->dropDownList($stateData, ['prompt' => 'Select Status'])->label('Request Status'); ?>
...
<style>
    .forminputpopup .form-group select{
        width: 69%;
        height: 52px;
    }
</style>