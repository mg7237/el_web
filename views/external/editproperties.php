...
?>
                            ...
                            <div style="padding-top:20px; text-align: right;" class="row pull-right col-lg-9 col-sm-9">
                ...
                <div id="p_features" class="tab-pane fade">
                    ...
                    <div class="col-md-10 col-sm-10">
                        <div class="parmentaddress">
                            ...
                            <div style="padding-top:20px;" class="row pull-right col-lg-8 col-sm-8">
                ...
                <div id="p_image" class="tab-pane fade">
                    ...
                    <div class="row" style= "width:50%; padding: 10px;">
                ...
                <div id="p_contract" class="tab-pane fade">
                    ...
                    <div class="col-md-10 col-sm-10">
                        <div class="parmentaddress parmentaddressnew">
                            ...
                            <?= $form->field($modelPropertyAgreements, 'notice_peroid')->textInput(['maxlength' => true, 'placeholder' => 'Notice Peroid*'])->label('Notice Period(Months)') ?>
                            <?= $form->field($modelPropertyAgreements, 'min_contract_peroid')->textInput(['maxlength' => true, 'placeholder' => 'Minnimum contract period*', 'class' => 'form-control isNumber'])->label('Minimum Contract Period(Months)') ?>
                            ...
                            <div style="padding-top:20px;" class="row pull-right col-lg-12 col-sm-12">
                                <div class="col-lg-4 col-sm-6">
                                    <button type="button" class="btn savechanges_submit_previous activate_property"  style="<?= $model->status == 1 ? 'font-size:20px;padding:12.5px' : 'font-size:19px;padding:11px' ?>" data-status="<?= $model->status == 1 ? '1' : '0' ?>"><?= $model->status == 1 ? 'Deactivate Property' : 'Activate Property' ?></button>
