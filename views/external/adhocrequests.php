...
<div class="col-lg-12 col-sm-12 selectright">
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-8 pull-right">  
                    <a href="<?php echo Url::home(true); ?>external/createadhoc" class="btn savechanges_submit_contractaction rightbtn" data-toggle="modal" data-target="#myModal" style= "margin-top:20px;">Create Adhoc Request</a>
                    ...
                    <div class="col-lg-8 col-sm-8 selectleft">
                        <form class="navbar-form navbar-search" action="" method="GET" role="search">
                            <div class="input-group">
                                ...
                                <input type="text" name="Request[search]" class="form-control" value="<?= $search; ?>" placeholder="Search by tenant name, title, request status ...">
                ...
                <div class="col-lg-12 col-sm-12 advisortetxt">
                    ...
                    echo GridView::widget([
                        ...
                        'rowOptions' => function ($model, $key, $index, $grid) {
                            $class = 'clickable-row';
                            return array('key' => $key, 'data-href' => Url::home(true) . 'external/adhocdetails?id=' . base64_encode($key), 'class' => $class);
                        },
                        'summary' => '',
                    ...
                    <div class="col-lg-4 col-sm-4"><button type="button" class="btn savechanges_submit_contractaction" id="btnExport">Export</button></div>
                </div>
...
<div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modalbg modalbgpopup" style="width:600px;">
