...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="parmentaddress col-lg-9 col-xs-offset-1">
        ...
        <div class="row">
            <div class="parmentaddress col-lg-9 col-xs-offset-1"> 
                ...
                <div class="parmentaddress resetbox">
                    ...
                    <?= $form->field($model, 'phone')->textInput(['maxlength' => 15, 'placeholder' => 'Contact Number*', 'class' => 'form-control'])->label(false) ?> 
        ...
        <div class="row">
            <div class="col-lg-9 col-xs-offset-1"> 
                ...
                <?= $form->field($model, 'emer_contact')->textInput(['maxlength' => true, 'class' => 'form-control isCharacter', 'placeholder' => 'Name*'])->label('Emergency Contact Name') ?>

                <?= $form->field($model, 'emergency_contact_email')->textInput(['maxlength' => true, 'class' => 'form-control', 'placeholder' => 'Email*'])->label('Emergency Contact Email') ?>


                <?= $form->field($model, 'emergency_contact_number')->textInput(['maxlength' => 15, 'class' => 'form-control', 'placeholder' => 'Number*'])->label() ?>
    ...
    <div class="row col-lg-9 col-xs-offset-1">
        <br>
    ...
    <div class="row col-lg-9 col-xs-offset-1">
        ...
        <div class="col-lg-6">
            <a style="color:#FFF" class="btn savechanges_submit cancel_confirm_2" href="<?= Url::home(true); ?>external/applicants" type="button">Cancel</a>
                        ...
                        <fieldset>
                            ...
                            <div class="">
                                <div class="controls">
                                    ...
                                    <input required="" id="tags1" name="userid" type="text" class="form-control" placeholder="Search Operation Person" class="input-medium" required="">
