    ...
    <div class="row">
            ...
            <div class="col-lg-7 col-sm-7 selectright mtnew">
                ...
                <form class="navbar-form navbar-search" role="search" method="post" id="filterform">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="search" placeholder="Search by applicant name, applicant email, applicant phone number, address, status">
        ...
        <div class="col-lg-12 col-sm-12">
            <table class="table table-bordered tableheadingrow" cellpadding="5">
                <thead>
                    <tr>
                        <th width="10%">Advisor Name<span class="glyphicon glyphicon-triangle-bottom" aria-hidden="true"></span></th>
                        <th width="11%">Advisor address <span class="glyphicon glyphicon-triangle-bottom" aria-hidden="true"></span></th>
                        <th width="12%">Status<span class="glyphicon glyphicon-triangle-bottom" aria-hidden="true"></span></th>
                        <th width="19%">Schedule date/Time<span class="glyphicon glyphicon-triangle-bottom" aria-hidden="true"></span></th>
                        <th width="16%">Next follow up date/time<span class="glyphicon glyphicon-triangle-bottom" aria-hidden="true"></span></th>
                        <th width="17%">Assigned sales person ID<span class="glyphicon glyphicon-triangle-bottom" aria-hidden="true"></span></th>
                    </tr>
                </thead>
                <tbody>
                    <?php
