...
<div id="page-wrapper">
    <div class="row">
        ...
        <div class="col-lg-4 pull-right">
            <a href="<?php echo Url::home(true); ?>operations/createowner" class="btn savechanges_submit" data-toggle="modal" data-target="#myModal" style= "margin-top:15px;">Create Property Owner Lead</a>
        </div>
        <div class="col-lg-12">
        ...
        <div class="col-lg-12">
            ...
            echo GridView::widget([
                ...
                'rowOptions' => function ($model, $key, $index, $grid) {
                    ...
                    return array('key' => $key, 'data-href' => Url::home(true) . 'operations/ownerssdetails?id=' . base64_encode($key), 'class' => $class);
                },
