    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="col-md-3" style="float: right;">
                <button type="button" class="btn savechanges_submit" data-toggle="modal" data-target="#myModal">Create Owner Lead</button>
            ...
            <table class="table table-bordered tableheadingrow" cellpadding="5">
                <thead>
                    <tr>
                        ...
                        <th width="11%">Referred by advisor</th>
                        <th width="12%">Applicant contact details </th>
                        <th width="19%">Status</th>
                        <th width="16%">Next follow up date and time</th>
                ...
                <tbody>
                    ...
                    foreach ($data as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><?= $value['reffered_name'] ?></td>
                            <td><?= $value['contact_number'] ?><br><?= $value['email_id'] ?></td>
                            <td><?= $value['ref_name'] ?></td>
                            <td><?= date('d/m/Y', strtotime($value['created_date'])) ?><br><?= date('h:i:sa', strtotime($value['created_date'])) ?></td>
