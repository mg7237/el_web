...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-4 pull-right">
            <a href="<?php echo Url::home(true); ?>operations/createapplicant" class="btn savechanges_submit" data-toggle="modal" data-target="#myModal2" style= "margin-top:15px;">Create Applicant Lead</a>
        </div>
        <div class="col-lg-12">
        ...
        <div class="col-lg-12">
            ...
            echo GridView::widget([
                ...
                'rowOptions' => function ($model, $key, $index, $grid) {
                    $class = 'clickable-row';
                    return array('key' => $key, 'data-href' => Url::home(true) . 'operations/applicantsdetails?id=' . base64_encode($key), 'class' => $class);
                },
                'summary' => '',
