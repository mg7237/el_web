...
<section id="why-easyleases">
    <div class="row">
        <h2 class="text-center">
            <p>REAL ESTATE MANAGEMENT COMPANIES IN BANGALORE</p>
        </h2>
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="card-body">
                <p>
                    <span>
                        If you are a home owner with rental properties to manage in Bangalore, you should seriously consider hiring a <b>real estate management / property management company</b> to manage your rental property.
                    </span></p>
                <p> <span>Professional<b>real estate management companies </b>as Easyleases help property owners in end-to-end management of your apartment/villa/independent house – from finding a tenant to &amp;<b>tenant management </b> including legal documentations & rental collection, <b>real estate maintenance,</b> etc. </span></p>
            <!--<p><span class="fa fa-check"></span> &nbsp; <span>We take care of your property end-to-end: property tax payments, rent collection &amp; deposit, furnishing, painting, ad-hoc maintenance issues, etc.</span></p>-->
                <p>
                    <span>
                        Again for tenants, <b>real estate management companies </b> as Easyleases provide a hassle-free, high quality living environment. 
                    </span></p>
            </div>
        </div>
    </div>
