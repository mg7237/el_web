...
<section id="section-1" style="margin-top: 100px;"style="margin-top: 100px;">
...
<section id="why-easyleases">
    <div class="row">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="card-body">
                <p><span class="fa fa-check"></span> &nbsp; <span>A DIPP recognized Start-Up in Bangalore, led by senior corporate professionals with over 30 years of collective experience</span></p>
                <p><span class="fa fa-check"></span> &nbsp; <span>100% transparency assured. Track your deposits &amp; rental income via a real-time dashboard</span></p>
                ...
                <p><span class="fa fa-check"></span> &nbsp; <span>Property marketing &amp; tenant acquisition</span></p>
                <p><span class="fa fa-check"></span> &nbsp; <span>Low property management charges</span></p>
            </div>
        </div>
    </div>
</section>
