...
<section id="why-easyleases">
    <div class="row">
        <h2 class="text-center">
            <p>HOUSE RENTAL WEBSITES IN BANGALORE</p>
        </h2>
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="card-body">
                <p>
                    <span>
                        Tired looking for that dream rental home that offers you & your family a peaceful living? While there are plenty of web destinations that offer you a rental house for your budget, what you should look for is a managed rental home. Rental homes managed professionally by companies as Easyleases offer far more convenience and bang for your rent as every maintenance need is taken care of. 
                    </span></p>
                <p> <span>Our managed, ready-to-let rental homes are freshly painted and cleaned so your family can live peacefully. Easyleases’ team takes care of your ad hoc maintenance issues as well. What more, you also get free access to an online dashboard that helps you stay current on your deposit & rental payments, payments falling due, status on your maintenance issues, lease history, etc.</span></p>
    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
            <div class="address-box">
                ...
                <p>Tel: <a style="color: black;" href="tel:+91 63646 75551">+91 63646 75551</a></p>
            </div>
        </div>
